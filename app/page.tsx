    ...
    <div style={{ paddingTop: 'var(--navbar-height)' }}>
      <div className={`relative min-h-screen ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-200'} font-inter text-4xl overflow-hidden transition-colors duration-300 mt-0 px-2 sm:px-4`}>
            ...
            <div className={`relative w-full ${darkMode ? 'bg-gray-700' : 'bg-white'} shadow-md py-16 shadow-black/30`}>
              <div className="relative w-full h-[300px] sm:h-[500px] lg:h-[900px]">
                <Image
                  ...
                  quality={75}
                />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-3xl sm:text-4xl lg:text-6xl text-white font-bold font-montserrat whitespace-pre-line text-center">
        ...
        <section id="projects" className="mt-12 mb-0 lg:mt-12 lg:mb-0 px-4 sm:px-12 py-10">
          <h2 className={`text-5xl sm:text-6xl lg:text-7xl ${darkMode ? 'text-white' : 'text-black'} font-montserrat font-semibold text-center mb-20 lg:mb-24`}>Projects</h2>
            ...
            <div className={`relative w-full max-w-[1950px] h-auto mx-auto ${darkMode ? 'bg-gray-700' : 'bg-white'} rounded-sm shadow-lg p-8 sm:p-24 lg:p-28`}>
              ...
              <div className="flex justify-center mt-40">
                <button
                  ...
                  className="bg-gray-100 h-[40px] w-[100px] sm:h-[60px] sm:w-[100px] md:h-[70px] md:w-[130px] lg:h-[90px] lg:w-[200px] text-lg sm:text-xl md:text-xl lg:text-xl font-inter font-medium transition-all duration-300 text-black flex items-center justify-center transform hover:scale-105 rounded-md mx-6"
                  style={{
        ...
        <section id="blog" className="mt-20 lg:mt-24 px-8 py-8">
          <h2 className={`text-5xl sm:text-6xl lg:text-7xl ${darkMode ? 'text-white' : 'text-black'} font-montserrat font-semibold text-center mb-20 lg:mb-24`}>My Blog</h2>
        ...
        <section id="skills" className="mt-20 lg:mt-24 px-8 py-8">
          <h2 className={`text-5xl sm:text-6xl lg:text-7xl ${darkMode ? 'text-white' : 'text-black'} font-montserrat font-semibold text-center mb-20 lg:mb-24`}>Skills</h2>
          <div className={`relative w-full max-w-[2000px] h-auto mx-auto ${darkMode ? 'bg-gray-800' : 'bg-gray-100'} rounded-lg shadow-lg px-12 py-20`}>
            <div className={`relative w-full max-w-[1950px] h-auto mx-auto ${darkMode ? 'bg-gray-700' : 'bg-white'} rounded-sm shadow-lg p-12 lg:p-20`}>
              <Skillz />
            </div>
