...
const SkillsPage = () => {
  ...
  return (
    <div className={`min-h-screen p-4 sm:p-8 ${darkMode ? 'bg-gray-900' : 'bg-gray-100'}`}>
      <div className="max-w-[80%] mx-auto">
        <div className={`rounded-lg shadow-lg p-6 mb-12 ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="w-full md:w-1/2">
              ...
              <ul className={`list-disc list-inside space-y-2 text-2xl sm:text-3xl font-medium ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
        ...
        <h1 className={`text-4xl sm:text-5xl font-bold text-center mb-8 ${darkMode ? 'text-gray-200' : 'text-gray-800'}`}>My Skills</h1>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {skills.map((skillGroup, index) => (
            <div key={index} className={`rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
              <h2 className={`text-2xl sm:text-3xl font-semibold mb-4 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>{skillGroup.category}</h2>
