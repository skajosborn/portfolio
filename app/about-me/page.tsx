    ...
    <div className="min-h-screen bg-black text-white">
      ...
      {/* Header Section */}
        <div className="text-center mt-12 mb-20 px-4 lg:px-0">
          <h1 className="text-4xl lg:text-6xl font-bold text-white mb-4">About Me</h1>
          <p className="text-xl lg:text-2xl font-light text-gray-300 mx-auto text-justify lg:max-w-none">
        ...
        {/* Skills Section */}
        <div className="my-20">
          <h2 className="text-3xl font-bold text-white mb-16 text-center">Skills & Expertise</h2>
...
function SkillSection({ title, skills }: SkillSectionProps) {
  return (
    <div className="flex-1 flex flex-col items-center">
      <h3 className="text-2xl font-semibold text-gray-600 mb-6">{title}</h3>
  ...
  return (
    <div className="group perspective-1000">
      <div className="relative w-32 h-32 text-xl font-medium text-white transition-transform duration-500 transform-style-3d group-hover:rotate-y-180">
        {/* Front Side */}
        <div className="absolute inset-0 flex items-center justify-center bg-gray-600 rounded-full shadow-lg backface-hidden border-4 border-black transition-all duration-300 group-hover:shadow-[0_0_15px_rgba(20,184,166,0.5)] group-hover:border-teal-400">
          {skill.name}
        </div>
        {/* Back Side */}
        <div className="absolute inset-0 flex items-center justify-center bg-white rounded-full shadow-lg rotate-y-180 backface-hidden group-hover:rotate-y-0 border-2 border-black transition-all duration-300 group-hover:shadow-[0_0_15px_rgba(20,184,166,0.5)] group-hover:border-teal-400">
