...
const ProjectCard: React.FC<ProjectCardProps> = ({ title, imageUrl, githubUrl, liveDemoUrl }) => {
  return (
    <div className="bg-white text-white p-6 rounded-lg w-112 text-center transform hover:-translate-y-2 transition-all duration-300 shadow-lg hover:shadow-2xl">
      ...
      {/* Title Section */}
      <h3 className="text-3xl font-bold mt-6 text-gray-800 tracking-tight">
        {title}
      </h3>
      ...
      <div className="flex justify-center gap-4 mt-8">
        <a 
          ...
          className="bg-gray-400 text-white h-[35px] w-[90px] sm:h-[45px] sm:w-[100px] md:h-[55px] md:w-[110px] lg:h-[65px] lg:w-[130px] text-md sm:text-lg md:text-xl lg:text-2xl font-mulish transition-all duration-300 flex items-center justify-center transform hover:scale-105 rounded-md hover:shadow-[0_0_10px_rgba(255,255,255,0.6),0_0_20px_rgba(255,255,255,0.5),0_0_30px_rgba(255,255,255,0.4),inset_0_0_10px_rgba(255,255,255,0.3),inset_0_0_20px_rgba(255,255,255,0.2)]"
          style={{
        ...
        <a 
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="bg-gray-200 h-[35px] w-[90px] sm:h-[45px] sm:w-[100px] md:h-[55px] md:w-[110px] lg:h-[65px] lg:w-[130px] text-md sm:text-lg md:text-xl lg:text-2xl font-mulish transition-all duration-300 text-black flex items-center justify-center transform hover:scale-105 rounded-md hover:shadow-[0_0_10px_rgba(255,255,255,0.6),0_0_20px_rgba(255,255,255,0.5),0_0_30px_rgba(255,255,255,0.4),inset_0_0_10px_rgba(255,255,255,0.3),inset_0_0_20px_rgba(255,255,255,0.2)]"
          style={{
            transition: 'all 0.3s ease',
            boxShadow: '3px 3px 5px rgba(0, 0, 0, 0.3), inset -2px -2px 5px rgba(0, 0, 0, 0.2), inset 2px 2px 5px rgba(255, 255, 255, 0.5)',
          }}
