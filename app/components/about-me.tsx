          ...
          <div className="flex flex-col lg:flex-row relative">
            <div className="flex-1 lg:mx-8">
              <div className="h-full p-12 lg:p-16 flex flex-col justify-start">
                <div className={`text-3xl lg:text-4xl ${darkMode ? 'text-gray-200' : 'text-black'} font-mono font-light text-center leading-relaxed space-y-8 tracking-wide [word-spacing:0.2em]`}>
                  <p>
