      ...
      <div className="hidden sm:flex gap-2 sm:gap-3 md:gap-4 lg:gap-6 ml-auto mr-4 sm:mr-6 md:mr-10 lg:mr-20">
        {['Home', 'About', 'Projects', 'Blog', 'Contact'].map((label) => (
          <a
            ...
            className="custom-btn h-[30px] w-[80px] sm:h-[40px] sm:w-[90px] md:h-[50px] md:w-[100px] lg:h-[60px] lg:w-[120px] text-md sm:text-lg md:text-xl lg:text-2xl font-mulish transition-all duration-300 bg-gray-300 relative text-black flex items-center justify-center transform hover:scale-105 rounded-md"
            style={{
